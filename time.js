...
$(document).ready(function () {
    ...
    function displayHightLightTms() {
        var name_array = [00, 20, 40, 00, 20, 40, 1200, 1220, 1240, 1300, 1320, 1340, 1400, 1420, 1440, 1500, 1520, 1540, 1600, 1620, 1640, 1700, 1720, 1740, 1800, 1820, 1840, 1900, 1920, 1940];
        var className;
        for (var i = 0; i < name_array.length; i++) {
